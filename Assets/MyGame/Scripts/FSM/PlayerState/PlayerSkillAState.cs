...
public class PlayerSkillAState : State<Player>
{
    public PlayerSkillAState(BaseStateMachine<Player> stateMachine, Player character) : base(stateMachine, character) { }
    private float m_Progress;
    AnimatorStateInfo m_StateInfo;
    public override void Enter()
    {
        m_Character.m_Animator.SetBool(CONST.SKILL_A, true);
        m_Character.StartCoroutine(DoDamage());
        m_Character.RemainMana(m_Character.m_SkillACost);
    }
    ...
    public override void Exit()
    {
        ...
        {
            m_Character.m_Animator.SetBool(CONST.SKILL_A, false);
        }
        m_Character.m_IsUseSkillA = false;
