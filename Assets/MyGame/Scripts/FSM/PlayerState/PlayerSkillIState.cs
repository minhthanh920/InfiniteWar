...
public class PlayerSkillIState : State<Player>
{
    public PlayerSkillIState(BaseStateMachine<Player> stateMachine, Player character) : base(stateMachine, character) { }
    ...
    public override void Exit()
    {
        ...
        {
            m_Character.m_Animator.SetBool(CONST.SKILL_I, false);
        }
        m_Character.m_IsUseSkillI = false;
